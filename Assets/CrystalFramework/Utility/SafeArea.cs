...
namespace Crystal
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        public void Refresh(bool a = false)
        {
        ...
        void ApplySafeArea(Rect r)
        {
            ...
            //    Panel.sizeDelta -= Vector2.up * 40 * StandardSafe.height / 720;
            //    Panel.localPosition = new Vector2(0, 20 * StandardSafe.height / 720);
            //}
            //else
            //{
            //    Panel.sizeDelta -= Vector2.up * 40 * StandardSafe.height / 720;
            //    LeanTween.moveLocalY(Panel.gameObject, 20 * StandardSafe.height / 720, 0.5f);
            //}
        ...
        public void StandardCanvas()
        {
            ...
            Panel.sizeDelta += Vector2.up * StaticData.HEIGHT_BANNER;
            Panel.localPosition -= new Vector3(0, StaticData.HEIGHT_BANNER / 2, 0);
